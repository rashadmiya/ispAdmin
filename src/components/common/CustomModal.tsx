...
//             {openedItem == 'Borrows' && (<BorrowModal isModalVisible={isModalVisible} modalHide={modalHide}/>)}
//             {/* {openedItem == 'Losses' && (<LossModal openedItem={openedItem} isModalVisible={isModalVisible} modalHide={modalHide}/>)} */}
//             {/* {openedItem == 'Loan To' && (<LossModal openedItem={openedItem} isModalVisible={isModalVisible} modalHide={modalHide}/>)} */}
//             {openedItem == 'Losses' && (<TemplateModal openedItem={openedItem} isModalVisible={isModalVisible} modalHide={modalHide}/>)}
