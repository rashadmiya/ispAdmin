...
//   let notice = useSelector((state: any) => state.notice.value);
    ...
    useEffect(() => {
        setLoading(true);
        const unsubscribe = firestore().collection('notices')
    ...
    return (
        <SafeAreaView style={{ flex: 1, backgroundColor: ConstantColor.white }}>
            ...
            <View style={global_styles.customContainer}>
                ...
                <View style={{}}>
                    <Text style={[global_styles.textMedium, { fontSize: 18 }]}>Notice</Text>
                </View>
                <View style={global_styles.sizedBoxTen}></View>
                <View style={global_styles.sizedBoxTen}></View>
